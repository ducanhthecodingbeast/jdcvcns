...
export VECTOR_BACKEND="${ENV_VECTOR_BACKEND:-${VECTOR_BACKEND:-pinecone}}"
export PINECONE_HOST="${ENV_PINECONE_HOST:-${PINECONE_HOST:-http://localhost:15080}}"
...
export WRITE_RESULTS="${ENV_WRITE_RESULTS:-0}"
...
export VIRANKER_BATCH_SIZE="${VIRANKER_BATCH_SIZE:-64}"
