...
def main():
    ...
    if not os.path.exists(jd_path):
        # Check raw CSV
        raw_jd = source_dir / "JOB_DATA_FINAL.csv"
    ...
    if cv_path is None:
        raise FileNotFoundError("Missing non-empty mockcv.csv in Data/. Generate it from the shared Dataset/mockcv.py.")
    ...
    cv_cache_path = EMBEDDING_CACHE_DIR / "cv_embeddings_v2.npy"
    jd_cache_path = EMBEDDING_CACHE_DIR / "jd_embeddings_v2.npy"
