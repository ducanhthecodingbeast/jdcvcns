...
from pipeline import DATASET_DIR, get_jd_text
...
def load_and_preprocess_jd(source_dir):
    ...
    if os.path.exists(jd_path):
        ...
        if not os.path.exists(raw_file):
            raise FileNotFoundError(f"Missing raw data {raw_file}. Please place it in the shared Data folder.")
...
def main():
    ...
    with conn.cursor() as cur:
        ...
        embeddings_cache_path = EMBEDDING_CACHE_DIR / "jd_embeddings.npy"
        jd_embeddings = None
