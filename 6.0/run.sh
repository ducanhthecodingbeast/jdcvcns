...
ENV_WRITE_RESULTS="${ENV_WRITE_RESULTS:-${WRITE_RESULTS:-}}"
ENV_BM25_REGEX_TOKENIZER="${ENV_BM25_REGEX_TOKENIZER:-${BM25_REGEX_TOKENIZER:-}}"
ENV_STORE_DB="${ENV_STORE_DB:-${STORE_DB:-}}"
ENV_CV_FILE="${ENV_CV_FILE:-${CV_FILE:-}}"
ENV_JD_FILE="${ENV_JD_FILE:-${JD_FILE:-}}"
ENV_RESULTS_JSON="${ENV_RESULTS_JSON:-${RESULTS_JSON:-}}"

export BM25_REGEX_TOKENIZER="${ENV_BM25_REGEX_TOKENIZER:-1}"
if [[ -n "${ENV_STORE_DB}" ]]; then export STORE_DB="${ENV_STORE_DB}"; fi
export WRITE_RESULTS="${ENV_WRITE_RESULTS:-1}"
export TOP_K="${TOP_K:-10}"
export CV_FILE="${ENV_CV_FILE:-mockcv.small.csv}"
export JD_FILE="${ENV_JD_FILE:-jd.csv}"
export RESULTS_JSON="${ENV_RESULTS_JSON:-file.json}"
