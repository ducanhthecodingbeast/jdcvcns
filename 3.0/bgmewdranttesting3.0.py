...
from report import render_cv_to_jd_report
...
def run_bgem3_qdrant(config: Config) -> dict[str, Any]:
    ...
    report_path = render_cv_to_jd_report(
        matches,
        config.results_dir / "results_3.0_bgem3_qdrant.html",
        title="CV Matching Results - BGE-M3 + Qdrant",
        subtitle="Hybrid retrieval with dense, sparse, and ColBERT reranking",
    )
